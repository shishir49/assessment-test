...
@section('content')
   <div class="create-form">
       ...
       <div class="mb-3 label">
            ...
            <input type="text" class="form-control" id="form-name" name="form_name" placeholder="Form Name" value="{{ $template->form_name }}">
        </div>
        ...
        <fieldset class="trial-form mt-3">
           <legend>Trial</legend>
           
           <div id="append-ele" class="append-ele">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div class="mb-3 radio-group-name">
                       ...
                       <input type="text" class="form-control" id="radio-group" placeholder="name@example.com">
                    </div>
                    <div class="mb-3 label">
                    ...
                    <div class="mb-3 options">
                       <label for="multi-options" class="form-label">Multi options&nbsp;&nbsp;<button class="btn btn-danger btn-sm add-op-ele float-right" type="button">+</button></label>
        ...
        <button type="submit" class="btn btn-danger mt-3 float-right">Update</button>
        </form>
    </div>
